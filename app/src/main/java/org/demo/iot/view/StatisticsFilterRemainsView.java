...
import org.demo.iot.view.CircleView;

/**
 * Created by silver on 2017/8/2.
 */

public class StatisticsFilterRemainsView extends CircleView {

    private RectF mRectF;
    private Paint mPaint;

    public StatisticsFilterRemainsView(Context context) {
        super(context);
        init();
    }

    public StatisticsFilterRemainsView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private void drawLabel(Canvas canvas) {
        ...
        drawText(canvas, x, y, 12, "Filter Remains");
    }
