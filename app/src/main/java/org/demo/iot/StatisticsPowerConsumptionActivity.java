...
public class StatisticsPowerConsumptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_statistics_power_consumption);
    ...
    private void initData() {
        ...
        mEntries.add(new Entry(10, 13));
        mEntries.add(new Entry(11, 15));
        mEntries.add(new Entry(12, 17));
        mEntries.add(new Entry(13, 15));
        mEntries.add(new Entry(14, 18));
        mEntries.add(new Entry(15, 15));
        mEntries.add(new Entry(16, 11));
        mEntries.add(new Entry(17, 10));
        mEntries.add(new Entry(18, 12));
        mEntries.add(new Entry(19, 13));
    }
    ...
    private void drawLineChart() {
        ...
        lineDataSet.setColor(Color.parseColor("#148f7f")); //折線顏色
        lineDataSet.setCircleColor(Color.parseColor("#148f7f")); //折線峰值外圈顏色
        lineDataSet.setCircleColorHole(Color.parseColor("#148f7f"));//折線峰值內圈顏色
        lineDataSet.setDrawValues(false); //顯示折線峰值文字
        lineDataSet.setDrawFilled(true); //支持折線下方填滿
        Drawable drawable = ContextCompat.getDrawable(this, R.drawable.bg_gradient_green);
